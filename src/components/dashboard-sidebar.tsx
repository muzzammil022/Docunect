...
const secondaryNavItems = [{ icon: Settings, label: "Settings", href: "#" }];
          ...
          >
            ...
            {!isCollapsed && (
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-xs text-foreground/60 uppercase tracking-wide">
                  Current
                </p>
                <p
